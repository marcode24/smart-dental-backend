...
__decorate([
    ...
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.DOUBLE({ decimals: 2 })),
    __metadata("design:type", Number)
...
__decorate([
    ...
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.BOOLEAN),
    __metadata("design:type", Boolean)
], Service.prototype, "odontogram", void 0);
__decorate([
    (0, sequelize_typescript_1.AllowNull)(true),
...
Service = __decorate([
    (0, sequelize_typescript_1.Table)({ timestamps: true, tableName: 'service', initialAutoIncrement: '10000' })
], Service);
